...
$this->Html->addCrumb('Static Page Add');
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title"><i class="icon-checkmark-circle"></i> <?php echo __('Add StaticPage'); ?></h6>
    ...
    <div class="panel-body">
        ...
        <div class="form-actions text-right">
            <input type="submit" value="Add Static Page" class="btn btn-primary">
        </div>
