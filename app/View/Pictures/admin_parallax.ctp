<?php 
$this->Html->addCrumb(MyClass::translate('Parallax'));
?>
...
<div class="tabbable page-tabs">
    <div class="tab-content">
        ...
        <div class="tab-pane active fade in" id="english">
            ...
            echo $this->Form->hidden('picture_block', array('value' => 'PL'));
            ?>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h6 class="panel-title"><i class="icon-paragraph-justify2"></i> <?php echo MyClass::translate("Edit Parallax"); ?></h6>
                </div>
