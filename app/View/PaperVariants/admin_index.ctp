<?php $this->Html->addCrumb(MyClass::translate('Paper Variants')); ?>
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title"><i class="icon-file6"></i> <?php echo MyClass::translate('Manage Paper Variants'); ?></h6>
    </div>
    <div class="table-responsive">
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th>#</th>
                    <th><?php echo MyClass::translate('Paper range in mg'); ?></th>
                    <th><?php echo MyClass::translate('Paper range in gram'); ?></th>
                    <th><?php echo MyClass::translate('Paper name'); ?></th>
