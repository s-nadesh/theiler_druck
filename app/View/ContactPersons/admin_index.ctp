...
<!--                                    <a title="" class="btn btn-link btn-icon btn-xs tip" href="<?php echo SITE_BASE_URL ?>admin/contact_persons/view/<?php echo $contactPerson['ContactPerson']['cont_pers_id']; ?>" data-original-title="<?php echo MyClass::translate("View"); ?>">
                                    ...
                                    <a title="" class="btn btn-link btn-icon btn-xs tip" href="<?php echo SITE_BASE_URL ?>admin/contact_persons/delete/<?php echo $contactPerson['ContactPerson']['cont_pers_id']; ?>" data-original-title="<?php echo MyClass::translate("Delete"); ?>" onclick="return confirm('Are you sure you wish to delete?');">
