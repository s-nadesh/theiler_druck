...
//print_r($this->data);
$this->Html->addCrumb(__('Pages'), array('controller' => 'pages', 'action' => 'index', 'admin' => true));
...
<div class="tabbable page-tabs">
    <ul class="nav nav-tabs">
        ...
        <li <?php if($j ==1){echo 'class="active"';}else {echo '';}?>><a href="#page-<?php echo $lang['LanguageType']['language_type_name']?>" data-toggle="tab"><i class="icon-paragraph-justify2"></i> <?php echo __($lang['LanguageType']['language_type_name']); ?> </a></li>
        <?php $j++; endforeach;?>
<!--        <li><a href="#page-2" data-toggle="tab"><i class="icon-coin"></i> <?php echo __('Product Price Calculation'); ?> </a></li>-->
    </ul>
  <?php
    ...
    <div class="tab-content">
        ...
        <div <?php if($i ==1){echo 'class="tab-pane active fade in"';}else {echo 'class="tab-pane fade"';}?> id="page-<?php echo $lang['LanguageType']['language_type_name']?>">
           ...
           <?php if($i ==1){echo '<div class="panel panel-default">
            ...
            <h6 class="panel-title"><i class="icon-paragraph-justify2"></i> <?php echo __('Add Page'); ?></h6>
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo __('Page Title'); ?>: <span class="mandatory">*</span></label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo __('Page Description'); ?>: <span class="mandatory">*</span></label>
                <div class="col-sm-10">
                            <?php
...
<?php if($i !=1){?>
            <div class="form-actions text-right">
                <input type="submit" value="<?php echo __("Save Page"); ?>" class="btn btn-primary">
            </div>
