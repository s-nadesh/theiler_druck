        ...
        <div class="row">
            <div class="col-md-12 chekout-step">
                ...
                <div class="row featured-boxes login">
                    <div class="col-md-12">
                        <h4><?php echo MyClass::translate("Shipping Address") ?></h4>
                        <div class="featured-box featured-box-secundary default info-content">
                            ...
                            <div class="box-content">
                                <legend> 
                                    <?php echo MyClass::translate("Choose Shipping Address"); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <p>
                                            ...
                                            &nbsp;<label for="shipping_identical"><?php echo MyClass::translate("Shipping address and billing address are identical"); ?></label>
                                        </p>
                                        <p>
                                            <input type="radio" value="0" name="data[ShippingAddress][identical]" id="shipping_new" <?php echo $shipping_new_checked ?>>
                                            &nbsp;<label for="shipping_new"><?php echo MyClass::translate("Create new shipping address"); ?></label>
                                        </p>
                                    </div>
                                </div>
