...
insert  into `td_email_templates`(`template_id`,`template_name`,`template_from`,`template_reply_to`,`template_subject`,`template_content`,`template_variables`,`template_success_message`,`created`,`modified`) values (1,'User Forgot Password','info@theilerdruck.ch','info@theilerdruck.ch','Reset Password Mail From - Theiler Druck','<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n    <tr>\r\n        <td  style=\"padding:20px 20px 0 20px\">\r\n            <p style=\"color: #545454; font-size: 13px; line-height: 20px;\">\r\n                Dear ##NAME##!\r\n            </p>\r\n            <p style=\"color: #545454; font-size: 13px; line-height: 20px;\">\r\n                We received a request to reset the password for your account.To reset your password, click on the button below (or copy/paste the URL into your browser).\r\n            </p>\r\n            <p style=\"color: #545454; font-size: 13px; line-height: 20px;\">\r\n                <a href=\"##RESET_LINK##\">Click to Reset Password</a>.\r\n            </p>\r\n            <p style=\"color: #545454; font-size: 13px; line-height: 20px;\">\r\n                This Password Link is valid for only 5 minutes from request time ##TIME_VALID##\r\n            </p>\r\n        </td>\r\n    </tr>\r\n</table>','NAME,RESET_LINK,TIME_VALID',NULL,'2015-06-20 19:00:00','2015-06-20 19:00:00');
...
CREATE TABLE `td_payment_methods` (
  ...
  `payment_caption` varchar(500) DEFAULT NULL,
...
insert  into `td_payment_methods`(`payment_id`,`payment_name`,`payment_caption`,`payment_fee`,`is_active`,`created`,`modified`) values (1,'Cash on delivery','Small information','5.04','0','2015-06-20 17:01:00','2015-06-20 17:01:00'),(2,'Bank transfer','You transfer the invoice amount in advance payment','0.00','1','2015-06-20 17:00:00','2015-06-20 17:46:24'),(3,'Invoice','Small information','0.00','1','2015-06-20 17:00:00','2015-06-20 17:00:00');
