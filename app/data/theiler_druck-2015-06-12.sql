...
CREATE TABLE `td_contact_addresses` (
  ...
  `cont_addr_type` enum('DF') NOT NULL DEFAULT 'DF',
  `cont_addr_address_1` varchar(500) NOT NULL,
  `cont_addr_address_2` varchar(500) DEFAULT NULL,
  `cont_addr_email` varchar(255) NOT NULL,
  `cont_addr_fax` varchar(255) DEFAULT NULL,
