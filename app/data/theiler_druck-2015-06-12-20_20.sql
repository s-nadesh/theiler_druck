...
insert  into `td_admins`(`admin_id`,`admin_name`,`admin_email`,`admin_password`,`admin_profile_image`,`admin_last_login`,`admin_login_ip`,`created`,`modified`) values (1,'Theiler Druck Admin ','admin@theilerdruck.com','c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec','lk75Y_New_MotoX_default_wallpaper.jpg','2015-06-12 18:09:21','127.0.0.1','2015-04-24 00:00:00','2015-06-12 18:09:21');
...
insert  into `td_contact_addresses`(`cont_addr_id`,`cont_addr_type`,`cont_addr_company`,`cont_addr_address_1`,`cont_addr_address_2`,`cont_addr_email`,`cont_addr_email_2`,`cont_addr_email_3`,`cont_addr_fax`,`cont_addr_phone`,`cont_addr_country`,`cont_addr_website`,`created`,`modified`) values (1,'DF','Theiler Druck AG','Verenastrasse 2','8832 Wollerau','info@theilerdruck.ch','','','044 787 03 01','044 787 03 00','Switzerland','','2015-06-12 16:47:28','2015-06-12 18:11:57'),(2,'A1','Hofner Volksblatt','Verenastrasse 2 ','8832 Wollerau ','redaktion@hoefner.ch','redaktion@hoefner.ch','','044 787 03 10','044 787 03 03','Switzerland','http://www.hoefner.ch','2015-06-12 16:47:28','2015-06-12 17:59:48'),(3,'A2','March-Anzeiger','Alpenblickstrasse 26','8853 Lachen','redaktion@marchanzeiger.ch','inserate@theilermediaservice.ch','','055 451 08 89','055 451 08 88','Switzerland','http://www.marchenzeiger.ch','2015-06-12 16:47:28','2015-06-12 18:00:08');
...
CREATE TABLE `td_order_items` (
  ...
  CONSTRAINT `FK_td_order_items` FOREIGN KEY (`order_id`) REFERENCES `td_orders` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
