...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2015 at 08:32 AM
...
(1, 'Theiler Druck Admin ', 'admin@theilerdruck.com', 'c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec', 'lk75Y_New_MotoX_default_wallpaper.jpg', '2015-06-01 15:46:38', '127.0.0.1', '2015-04-24 00:00:00', '2015-06-01 15:46:38');
...
CREATE TABLE IF NOT EXISTS `td_product_answers` (
  ...
  KEY `FK_td_product_answers` (`question_id`)
...
ALTER TABLE `td_product_answers`
  ADD CONSTRAINT `FK_td_product_answers` FOREIGN KEY (`question_id`) REFERENCES `td_product_questions` (`question_id`);
